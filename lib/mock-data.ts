...
export const MOCK_CENTERS: readonly Center[] = [
  {
    ...
    slug: 'bella-vita-spa',
    name: 'Bella Vita Spa',
    description: 'Experience luxury and relaxation at Bella Vita Spa. Our expert team provides premium beauty treatments in a serene environment.',
    logo: '💆‍♀️',
    services: [
      {
        id: 'service-1-1',
      ...
      },
      {
        ...
        description: 'Full body relaxation massage to relieve tension and stress',
        duration: 90,
        price: 12000, // $120.00
        centerId: 'center-1',
      },
  ...
  },
  {
    ...
    description: 'Modern beauty lounge offering cutting-edge treatments and personalized care. Transform your look with our skilled professionals.',
    logo: '✨',
    services: [
      {
        id: 'service-2-1',
  ...
  },
  {
    ...
    description: 'Holistic wellness center combining beauty treatments with mindfulness. Rejuvenate your body, mind, and spirit.',
    logo: '🧘‍♀️',
    services: [
      {
        id: 'service-3-1',
        name: 'Aromatherapy Massage',
        description: 'Relaxing massage with essential oils tailored to your needs',
        duration: 60,
        price: 9500, // $95.00
        centerId: 'center-3',
      },
      ...
      },
      {
        ...
        description: 'Foot massage targeting pressure points for overall wellness',
        duration: 45,
        price: 6000, // $60.00
        centerId: 'center-3',
      },
